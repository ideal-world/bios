...
--- config
    location /t {
        content_by_lua_block {
            ...
            m_resource.add_res("GET","api://*.*/**",{app_codes="#app1#app2#",tenant_codes="#tenant1#"})
            m_resource.add_res("GET","api://app1.tenant1/p1",{account_codes="#acc#"})
            m_resource.add_res("GET","api://app1.tenant1/p1/p2",{role_codes="#role1#"})
            m_resource.add_res("GET","api://app1.tenant1/p1/p2/*",{role_codes="#role1#"})
            m_resource.add_res("GET","api://app1.tenant1/p1/p2/**",{role_codes="#role1#"})
            m_resource.add_res("GET","api://app1.tenant1/p4/p2/**",{role_codes="#role1#"})
            m_resource.add_res("GET","api://app1.tenant1/*/p2",{role_codes="#role1#"})
            m_resource.add_res("GET","api://app1.tenant1/**/p5",{role_codes="#role1#"})
            m_resource.add_res("GET","api://app1.tenant1/p1?q1=aa",{role_codes="#role1#"})
            m_resource.add_res("GET","api://app1.tenant1/p1?q1=aa&q2=bb",{role_codes="#role1#"})
            m_resource.add_res("POST","api://app1.tenant1/p1?q1=aa&q2=bb",{role_codes="#role1#"})
