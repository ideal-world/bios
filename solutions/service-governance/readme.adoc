...
helm install kiwigrid/fluentd-elasticsearch --name bios-fluentd-es --namespace devops --version=3.0.0 \
    --set elasticsearch.host=bios-elasticsearch-master \
    ...
    --set prometheusRule.labels.release=bios-prometheus-operator \
    --set serviceMonitor.enabled=true \
    --set serviceMonitor.labels.release=bios-prometheus-operator \
