        ...
        .exec(
            &Query::insert()
                ...
                .values_panic(vec![
                    ...
                    group_add_req.icon.as_ref().unwrap_or(&"".to_string()).to_string().into(),
                    group_add_req.sort.into(),
                    group_add_req.rel_group_id.as_ref().unwrap_or(&"".to_string()).to_string().into(),
                    group_add_req.rel_group_node_id.as_ref().unwrap_or(&"".to_string()).to_string().into(),
        ...
        .exec(
            &Query::insert()
                ...
                .values_panic(vec![
                    ...
                    ident_info.account_id.clone().into(),
                    code.clone().into(),
                    group_node_add_req.bus_code.as_ref().unwrap_or(&"".to_string()).to_string().into(),
                    group_node_add_req.name.clone().into(),
                    group_node_add_req.sort.into(),
                    group_node_add_req.parameters.as_ref().unwrap_or(&"".to_string()).to_string().into(),
                    group_id.into(),
                ])
                .done(),
            None,
