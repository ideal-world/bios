...
pub struct ReachTriggerInstanceConfigCcApi;

/// Common Console Reach Trigger Instance Config API
/// 通用控制台触达触发实例配置API
#[cfg_attr(feature = "simple-client", bios_sdk_invoke::simple_invoke_client(Client<'_>))]
#[poem_openapi::OpenApi(prefix_path = "/cc/trigger/instance/config", tag = "bios_basic::ApiTag::Common")]
impl ReachTriggerInstanceConfigCcApi {
