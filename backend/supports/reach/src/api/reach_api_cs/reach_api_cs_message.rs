...
/// 用户触达消息-平台控制台
pub struct ReachMessageCsApi;

/// System Console Reach Message API
/// 平台控制台触达消息API
#[cfg_attr(feature = "simple-client", bios_sdk_invoke::simple_invoke_client(Client<'_>))]
#[poem_openapi::OpenApi(prefix_path = "/cs/msg", tag = "bios_basic::ApiTag::System")]
impl ReachMessageCsApi {
    /// 获取所有用户触达消息数据分页
    /// 获取所有用户触达消息数据分页
