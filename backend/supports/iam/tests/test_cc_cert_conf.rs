...
async fn test_single_level(context: &TardisContext, another_context: &TardisContext) -> TardisResult<()> {
    ...
    let user_pwd_cert_conf = IamCertServ::paginate_cert_conf(
        None,
        Some(IamCertKernelKind::UserPwd.to_string().into()),
        None,
        false,
        None,
        1,
    ...
    let cert_conf_user_pwd_id = user_pwd_cert_conf.records.first().unwrap().id.clone();
    ...
    let cert_conf_mail_vcode = IamCertServ::paginate_cert_conf(
        None,
        Some(IamCertKernelKind::MailVCode.to_string().into()),
        None,
        false,
        None,
        1,
    ...
    .await?;
    let cert_conf_mail_vcode_id = cert_conf_mail_vcode.records.first().unwrap().id.clone();
    ...
    let cert_conf_phone_vcode = IamCertServ::paginate_cert_conf(
        None,
        Some(IamCertKernelKind::PhoneVCode.to_string().into()),
        None,
        false,
        None,
        1,
    ...
    .await?;
    let cert_conf_phone_vcode_id = cert_conf_phone_vcode.records.first().unwrap().id.clone();
