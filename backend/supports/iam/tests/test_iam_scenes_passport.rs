    ...
    let account_id: String = client
        .post(
            ...
            &IamAccountAggAddReq {
                ...
                disabled: None,
                icon: None,
                exts: Some(HashMap::from([("ext9".to_string(), "00001".to_string())])),
                status: None,
                temporary: None,
                lock_status: None,
                logout_type: None,
    ...
    assert!(client
        .post_resp::<IamTenantAggAddReq, String>(
            ...
            &IamTenantAggAddReq {
                ...
                admin_name: TrimString("测试管理员".to_string()),
                admin_username: TrimString("tenant_admin".to_string()),
                admin_password: Some(TrimString("aaaa".to_string())),
                admin_phone: None,
                admin_mail: None,
                audit_username: TrimString("audit".to_string()),
                audit_name: TrimString("审计管理员".to_string()),
    ...
    assert!(client
        .post_resp::<IamTenantAggAddReq, String>(
            ...
            &IamTenantAggAddReq {
                ...
                admin_name: TrimString("测试管理员".to_string()),
                admin_username: TrimString("tenant_admin".to_string()),
                admin_password: Some(TrimString("aa22".to_string())),
                admin_phone: None,
                admin_mail: None,
                audit_username: TrimString("audit".to_string()),
                audit_name: TrimString("审计管理员".to_string()),
    ...
    assert!(client
        .post_resp::<IamTenantAggAddReq, String>(
            ...
            &IamTenantAggAddReq {
                ...
                admin_name: TrimString("测试管理员".to_string()),
                admin_username: TrimString("tenant_admin".to_string()),
                admin_password: Some(TrimString("aa22A".to_string())),
                admin_phone: None,
                admin_mail: None,
                audit_username: TrimString("audit".to_string()),
                audit_name: TrimString("审计管理员".to_string()),
    ...
    let tenant_id: String = client
        .post(
            ...
            &IamTenantAggAddReq {
                ...
                admin_name: TrimString("测试管理员".to_string()),
                admin_username: TrimString("tenant_admin".to_string()),
                admin_password: Some(TrimString("A3a#f".to_string())),
                admin_phone: None,
                admin_mail: None,
                audit_username: TrimString("audit".to_string()),
                audit_name: TrimString("审计管理员".to_string()),
    ...
    let _global_account_id: String = client
        .post(
            ...
            &IamAccountAggAddReq {
                ...
                cert_password: Some(TrimString("1234567".to_string())),
                cert_phone: None,
                cert_mail: None,
                role_ids: None,
                org_node_ids: None,
        ...
        .post(
            ...
            &IamTenantAggAddReq {
                ...
                cert_conf_by_ldap: Some(IamCertConfLdapAddOrModifyReq {
                    supplier: Some(TrimString(LDAP_SUPPLIER2.to_string())),
    ...
    let _tenant1_account_id: String = client
        .post(
            ...
            &IamAccountAggAddReq {
                ...
                cert_password: Some(TrimString(tenant1_user1_pwd.to_string())),
                cert_phone: None,
                cert_mail: None,
                role_ids: None,
                org_node_ids: None,
