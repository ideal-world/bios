...
impl CacheCiProcApi {
    ...
    async fn set(&self, req: Json<KvReq>, ctx: TardisContextExtractor) -> TardisApiResult<Void> {
    ...
    async fn set_ex(&self, req: Json<KvWithExReq>, ctx: TardisContextExtractor) -> TardisApiResult<Void> {
        let funs = crate::get_tardis_inst();
    ...
    async fn set_nx(&self, req: Json<KvReq>, ctx: TardisContextExtractor) -> TardisApiResult<bool> {
        let funs = crate::get_tardis_inst();
    ...
    async fn get(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<Option<String>> {
        let funs = crate::get_tardis_inst();
    ...
    async fn getset(&self, req: Json<KvReq>, ctx: TardisContextExtractor) -> TardisApiResult<Option<String>> {
        let funs = crate::get_tardis_inst();
    ...
    async fn incr(&self, req: Json<KIncrReq>, ctx: TardisContextExtractor) -> TardisApiResult<i64> {
        let funs = crate::get_tardis_inst();
    ...
    async fn del(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<Void> {
        let funs = crate::get_tardis_inst();
    ...
    async fn exists(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<bool> {
        let funs = crate::get_tardis_inst();
    ...
    async fn expire(&self, req: Json<ExpReq>, ctx: TardisContextExtractor) -> TardisApiResult<Void> {
        let funs = crate::get_tardis_inst();
    ...
    async fn ttl(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<u64> {
        let funs = crate::get_tardis_inst();
    ...
    async fn lpush(&self, req: Json<KvReq>, ctx: TardisContextExtractor) -> TardisApiResult<Void> {
        let funs = crate::get_tardis_inst();
    ...
    async fn lrangeall(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<Vec<String>> {
        let funs = crate::get_tardis_inst();
    ...
    async fn llen(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<u64> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hget(&self, req: Json<KfReq>, ctx: TardisContextExtractor) -> TardisApiResult<Option<String>> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hset(&self, req: Json<KfvReq>, ctx: TardisContextExtractor) -> TardisApiResult<Void> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hset_nx(&self, req: Json<KfvReq>, ctx: TardisContextExtractor) -> TardisApiResult<bool> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hdel(&self, req: Json<KfReq>, ctx: TardisContextExtractor) -> TardisApiResult<Void> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hincr(&self, req: Json<KfIncrReq>, ctx: TardisContextExtractor) -> TardisApiResult<i64> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hexists(&self, req: Json<KfReq>, ctx: TardisContextExtractor) -> TardisApiResult<bool> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hkeys(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<Vec<String>> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hvals(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<Vec<String>> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hgetall(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<HashMap<String, String>> {
        let funs = crate::get_tardis_inst();
    ...
    async fn hlen(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<u64> {
        let funs = crate::get_tardis_inst();
    ...
    async fn setbit(&self, req: Json<KbvReq>, ctx: TardisContextExtractor) -> TardisApiResult<bool> {
        let funs = crate::get_tardis_inst();
    ...
    async fn getbit(&self, req: Json<KbReq>, ctx: TardisContextExtractor) -> TardisApiResult<bool> {
        let funs = crate::get_tardis_inst();
    ...
    async fn bitcount(&self, req: Json<KReq>, ctx: TardisContextExtractor) -> TardisApiResult<u32> {
        let funs = crate::get_tardis_inst();
