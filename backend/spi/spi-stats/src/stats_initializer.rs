...
use crate::{
    api::ci::{stats_ci_conf_api, stats_ci_metric_api, stats_ci_record_api, stats_ci_schema_api, stats_ci_sync_api, stats_ci_transfer_api},
    ...
    web_server
        .add_module(
            ...
            (
                ...
                stats_ci_schema_api::StatsCiSchemaApi,
