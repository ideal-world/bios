...
use serde::Serialize;
use tardis::{web::poem_openapi, db::sea_orm::{self, DeriveActiveEnum, EnumIter}};
use strum_macros::{EnumString, Display};

#[derive(Debug, poem_openapi::Enum, EnumIter, Clone, Copy, DeriveActiveEnum, PartialEq, Eq, Serialize)]
