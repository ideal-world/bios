...
fn gen_update_sql_stmt<'a>(fields_and_values: impl IntoIterator<Item = (&'a str, Value)>, key_and_values: impl IntoIterator<Item = (&'a str, Value)>) -> (String, String, Vec<Value>) {
