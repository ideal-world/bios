...
--- config
    location /t {
        content_by_lua_block {
            ...
            m_resource.add_res("GET","iam-res://iam-serv",{st=ngx.time(),et=ngx.time()+3600,apps="#app1#app2#",tenants="#tenant1#"})
            m_resource.add_res("GET","iam-res://*/**",{st=ngx.time(),et=ngx.time()+3600,apps="#app1#app2#",tenants="#tenant1#"})
            m_resource.add_res("GET","iam-res://iam-serv/p1",{st=ngx.time(),et=ngx.time()+3600,accounts="#acc#"})
            m_resource.add_res("GET","iam-res://iam-serv/p1/p2",{st=ngx.time(),et=ngx.time()+3600,roles="#role1#"})
            m_resource.add_res("GET","iam-res://iam-serv/p1/p2/*",{st=ngx.time(),et=ngx.time()+3600,roles="#role1#"})
            m_resource.add_res("GET","iam-res://iam-serv/p1/p2/**",{st=ngx.time(),et=ngx.time()+3600,roles="#role1#"})
            m_resource.add_res("GET","iam-res://iam-serv/p4/p2/**",{st=ngx.time(),et=ngx.time()+3600,roles="#role1#"})
            m_resource.add_res("GET","iam-res://iam-serv/*/p2",{st=ngx.time(),et=ngx.time()+3600,roles="#role1#"})
            m_resource.add_res("GET","iam-res://iam-serv/**/p5",{st=ngx.time(),et=ngx.time()+3600,roles="#role1#"})
            m_resource.add_res("GET","iam-res://iam-serv/p1?q1=aa",{st=ngx.time(),et=ngx.time()+3600,roles="#role1#"})
            m_resource.add_res("GET","iam-res://iam-serv/p1?q1=aa&q2=bb",{st=ngx.time(),et=ngx.time()+3600,roles="#role1#"})
            m_resource.add_res("POST","iam-res://iam-serv/p1?q1=aa&q2=bb",{st=ngx.time(),et=ngx.time()+3600,roles="#role1#"})
