...
impl<'a> RbumCrudOperation<'a, rbum_kind::ActiveModel, RbumKindAddReq, RbumKindModifyReq, RbumKindSummaryResp, RbumKindDetailResp> for RbumKindServ {
    ...
    fn package_add(add_req: &RbumKindAddReq, _: &TardisContext) -> rbum_kind::ActiveModel {
    ...
    fn package_modify(id: &str, modify_req: &RbumKindModifyReq, _: &TardisContext) -> rbum_kind::ActiveModel {
...
impl<'a> RbumCrudOperation<'a, rbum_kind_attr::ActiveModel, RbumKindAttrAddReq, RbumKindAttrModifyReq, RbumKindAttrSummaryResp, RbumKindAttrDetailResp> for RbumKindAttrServ {
    ...
    fn package_add(add_req: &RbumKindAttrAddReq, _: &TardisContext) -> rbum_kind_attr::ActiveModel {
    ...
    fn package_modify(id: &str, modify_req: &RbumKindAttrModifyReq, _: &TardisContext) -> rbum_kind_attr::ActiveModel {
    ...
    async fn before_add_rbum(add_req: &RbumKindAttrAddReq, db: &TardisRelDBlConnection<'a>, cxt: &TardisContext) -> TardisResult<()> {
