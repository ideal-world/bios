        ...
        let rbum_cert_id: String = db
            .insert_one(
                rbum_cert::ActiveModel {
                    ...
                    start_time: Set(rbum_cert_add_req.start_time.unwrap_or_else(Utc::now).naive_utc()),
                    end_time: Set(rbum_cert_add_req.end_time.unwrap_or_else(Utc::now).naive_utc()),
                    ...
                    rel_rbum_cert_conf_id: Set(rel_rbum_cert_conf_id.unwrap_or_else(|| "".to_string())),
                    rel_rbum_domain_id: Set(rel_rbum_domain_id.unwrap_or_else(|| "".to_string())),
                    rel_rbum_item_id: Set(rel_rbum_item_id.unwrap_or_else(|| "".to_string())),
                    ..Default::default()
                },
                cxt,
            )
