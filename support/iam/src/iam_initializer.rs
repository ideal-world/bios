...
use crate::basic::dto::iam_cert_conf_dto::{
    IamCertConfMailVCodeAddOrModifyReq, IamCertConfPhoneVCodeAddOrModifyReq, IamCertConfUserPwdAddOrModifyReq,
};
...
use crate::console_common::api::{iam_cc_account_api, iam_cc_app_api, iam_cc_cert_api, iam_cc_org_api, iam_cc_res_api, iam_cc_role_api, iam_cc_system_api, iam_cc_tenant_api};
use crate::console_interface::api::iam_ci_cert_api;
    ...
    web_server
        .add_module(
            ...
            (
                ...
                (iam_ci_cert_api::IamCiCertApi, iam_ci_cert_api::IamCiCertManageApi),
            ),
        )
        .await;
    Ok(())
